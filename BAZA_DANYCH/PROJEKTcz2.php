...
$wynik=$polaczenie -> query($sql);
    ...
    while(($rekord= $wynik ->fetch_assoc())  !=null)
    {
            ...
            echo '<td>'."<button type='submit' formaction='PROJEKT_edit.php'><img src='https://st2.depositphotos.com/5266903/11961/v/950/depositphotos_119619980-stock-illustration-edit-document-stroke-vector-icon.jpg' width='12' height='12'></button>".'</td>';
            echo '<td>'."<button type='submit' formaction='PROJEKT_remove.php';><img src='https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/apple/129/cross-mark_274c.png' width='12' height='12'></button>".'</td>';
            echo '</tr>';
            echo '</form>';
...
<head>
    ...
    <body>
        <form method="post">
            ...
            <input type="submit"  value="Eksportuj dane" formaction="PROJEKT_file_name.php">
        </form>
        <br><br>    
    </body>
</html>