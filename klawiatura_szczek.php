    ...
    <div class="row d-none d-xl-block">    
      ...
      <div class="col-sm" style="text-align: center;">
        ...
        <form id='zapisywanie' method='POST'>
          <input type='hidden' value='3' name='instrumentId'>
        ...
        <?php
            ...
            ?>
            </select> <button type='submit' formaction='klawiatura_szczek.php'>Wczytaj</button><button type='submit' formaction='delete.php'>Usuń</button><br><br>
